...
raw_ASV_table_trimmed <- raw_ASV_table[,nchar(colnames(raw_ASV_table)) %in% 414:441]
...
save(taxa_train, file = "data/01_DADA2/taxa_train.RData")

load("data/01_DADA2/noChimeras_ASV_table.RData")
load("data/01_DADA2/taxa_train.RData")
taxa_train <- 
