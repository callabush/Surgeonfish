...
knitr::opts_chunk$set(echo = TRUE,
                      fig.align = "center",
                      fig.path = "../figures/03_Phylogenetic_Tree_epulos/")
```
...
# Load in the tree!
unrooted_tree <- read.tree("data/07_Phylogenetic_Tree_epulos/ASVs_unrooted.tree")
unrooted_tree
str(unrooted_tree)
```
...
save(list = c("unrooted_physeq", "midroot_physeq"),
     file = "data/07_Phylogenetic_Tree_epulos/phytree_preprocessed_physeq.RData")
```
